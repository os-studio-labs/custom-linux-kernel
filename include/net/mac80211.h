...
/* ── MLO (Multi-Link Operation) extensions ─────────────── */
	/**
	 * @mlo_link_status: per-link status bitmap (bit N = link N is active)
	 */
	u16 mlo_link_status;

	/**
	 * @mlo_assoc_link_id: link ID used for association (primary link)
	 */
	u8 mlo_assoc_link_id;

	/**
	 * @mlo_num_active_links: number of currently active links
	 */
	u8 mlo_num_active_links;

	/**
	 * @mlo_link_rssi: per-link RSSI for link selection
	 */
	s8 mlo_link_rssi[IEEE80211_MLD_MAX_NUM_LINKS];

	/**
	 * @mlo_primary_link_tx: if true, prefer primary link for TX
	 */
	bool mlo_primary_link_tx;

	/**
	 * @mlo_emlsr: if true, this link operates in EMLSR mode
	 */
	bool mlo_emlsr;

	/**
	 * @mlo_emlmr: if true, this link operates in EMLMR mode
	 */
	bool mlo_emlmr;
};
...
/* ── MLO (Multi-Link Operation) helpers ───────────────── */
